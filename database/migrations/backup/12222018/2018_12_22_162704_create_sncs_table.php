...
class CreateSncsTable extends Migration {
	...
	public function up()
	{
		Schema::create('sncs', function(Blueprint $table)
		{
			...
			$table->float('total_invest', 10, 0)->default('0::double precision');
			$table->float('tax_rate', 10, 0)->default('0::double precision');
			$table->float('total_amount_ri', 10, 0)->default('0::double precision');
			$table->float('total_net_intake', 10, 0)->default('0::double precision');
			$table->float('total_hono', 10, 0)->default('0::double precision');
			$table->float('total_comm_cgp', 10, 0)->default('0::double precision');
			$table->float('total_comm_app', 10, 0)->default('0::double precision');
			$table->float('total_get', 10, 0)->default('0::double precision');
			$table->float('investors_tax_reservation', 10, 0)->default('0::double precision');
			$table->float('investors_tax_proposition', 10, 0)->default('0::double precision');
