...
class ReservationImport implements ToModel, WithProgressBar, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        ...
        return new Reservation([
            ...
            "mandat_reserved_at" => $mandat_reserved_at->format('Y-m-d'),
            "mandat_start_at" => $mandat_start_at->format('Y-m-d'),
            "mandat_finnish_at" => $mandat_finnish_at->format('Y-m-d'),
        ]);
    }
}