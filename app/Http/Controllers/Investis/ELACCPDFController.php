...
class ELACCPDFController extends VoyagerBaseController
{
    ...
    public function generatePDF(Request $request){
        ...
        //return view('pdf.03_el_acc.03_el_acc', $data);
        $pdf = PDF::loadView('pdf.03_el_acc.03_el_acc', $data);

        return $pdf->download('el_acc.pdf');
