...
class SOCCLPDFController extends VoyagerBaseController
{
    ...
    public function generatePDF(Request $request){
        ...
        //return view('pdf.02_soc_cl.02_soc_cl', $data);
        $pdf = PDF::loadView('pdf.02_soc_cl.02_soc_cl', $data);

        return $pdf->download('soc_cl.pdf');
