...
{{--<body>--}}
{{--<div>--}}
    {{--<img src="http://127.0.0.1:8000/images/logo2.jpg" style="height: 80px" alt="logo">--}}
{{--</div>--}}
...
{{--<div id="body">--}}
    ...
    {{--<p class="text">--}}
        {{--NAME, REGISTRATION au capital de $capital euros, ayant son siège social--}}
        {{--ADDRESS - 123 - VILLE, immatriculée IMMATRIC  sous le--}}
        {{--numéro KEY, immatriculée à 123.<br>Représentée par--}}
        {{--M. PRENOM REPRESENT, en qualité de FONCTION,<br>D'autre part,--}}
    {{--</p>--}}
    ...
    {{--<p class="text">--}}
        {{--FAIT A : VILLE, LE 05-01-2019<br>--}}
        {{--En deux exemplaires originaux<br><br><br>--}}
    {{--</p>--}}
    {{--<div class="row text">--}}
        {{--<div class="col">Pour NAME</div>--}}
    ...
    {{--<div class="cell">BAREME DE COMMERCIALISATION 2019</div>--}}

    {{--<div class="text">--}}
        {{--Rentabilité investisseur et honoraires de commercialisation attribuée par INVESTIS DOM au--}}
        {{--cabinet NAME pour présentation d'investisseurs :--}}
    {{--</div>--}}
