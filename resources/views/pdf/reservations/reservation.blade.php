...
<DIV id="page_5">
    <DIV id="id5_1">
        ...
        <P class="p28 ft3">Je suis informé(e) que les formalités d'enregistrement s'élèvent à {{ number_format(($reservation->nbr_snc*60)+($reservation->montant_reduction/1000)+($reservation->assistance_juridique && in_array($formulae->id, [1, 3]) ? $reservation->nbr_snc*75 : 0), 2, ","," ") }} euros que je m'engage à payer au gérant des SNC.</P>
