                    ...
                    <div class="panel panel-bordered" style="padding-bottom:5px;">
                        ...
                        <div class="row">
                            <div class="col-md-12" style="border-bottom:0;">
                                <h3 class="text-{{$rowDetails->section->align ?? 'center'}}"
                                    style="color: {{$rowDetails->section->color ?? '#333'}};background-color: {{$rowDetails->section->bgcolor ?? '#f0f0f0'}};padding: 5px; padding-left: 15px;">{{$rowDetails->section->text}}</h3>
                            </div>
                                @endif
