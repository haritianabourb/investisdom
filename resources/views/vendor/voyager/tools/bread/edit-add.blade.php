                            ...
                            @foreach($fieldOptions as $data)
                                ...
                                <div class="row row-dd">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <textarea id="json-input-{{ $data['field'] }}" class="resizable-editor" data-editor="json" name="field_details_{{ $data['field'] }}">@if(isset($dataRow->details)){{ json_encode($dataRow->details)}}@endif</textarea>
                                    </div>
                                </div>
