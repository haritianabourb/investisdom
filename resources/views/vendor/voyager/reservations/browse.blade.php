                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endforeach
                                                <a type="button" href="{{ route('admin.reservations.generate-recherche', ['reservation' => $data]) }}" class="btn btn-default generate-pdf-convention"><i class="voyager-documentation"></i> Generer la convention</a>
                                        </td>
                                    </tr>
                                    @endcan
                                    @endforeach
